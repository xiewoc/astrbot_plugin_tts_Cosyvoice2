...
app = FastAPI()
global remove_think_tag ,instruct_speech_form ,zero_shot_text ,generate_method
...
def run_service(if_remove_think_tag,if_preload,inpt_instruct_speech_form ,inpt_zero_shot_text ,inpt_generate_method):
    global remove_think_tag ,instruct_speech_form ,zero_shot_text ,generate_method
...
async def generate_speech(request: Request, speech_request: SpeechRequest):
    ...
    prompt_speech_16k_name = speech_request.voice 
    print("using",prompt_speech_16k_name,"as tts zero shot source file")
    ...
    try:
        ...
        sound_path = ts.wav2mp3(ts.TTS(input_text,prompt_speech_16k_name,speech_form,script_path,generate_method,zero_shot_text),script_path)
